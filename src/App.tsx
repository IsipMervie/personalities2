...
import { popular_genius } from './data';
...
export default function Gallery() {
  ...
  function handleBackClick() {
    if (index == 0) {
      setIndex(popular_genius.length - 1);
    } else {
      setIndex(index - 1);
    }
  }
  ...
  let softwareDeveloper = popular_genius[index];

  return (
    <Card variant="outlined" sx={{ maxWidth: 600, minHeight: 400}}>
      <CardHeader
        title="POPULAR GENIUS"
        subheader="Mervie V. Isip - C-PEITEL3"
      />
      ...
      <CardContent>
        ...
        {index + 1 + " of " + popular_genius.length}
        </Typography>
      </CardContent>
